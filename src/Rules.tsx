...
export function Rules() {
  return (
    <Box>
      <Typography variant='h2'>Règles</Typography>
      <Typography variant='h3'>Préparation</Typography>
      ...
      <Typography variant='h3'>Objectif</Typography>
      <Typography variant='body1'>
      ...
      <Typography variant='h3'>Déroulement de la partie</Typography>
      <Typography variant='body1'>
      ...
      <Typography variant="h4">Déplacement</Typography>
      <Typography variant="body1">
